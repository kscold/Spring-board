...
@WebMvcTest(ArticleController.class) // 입력했던 컨트롤러만 읽음
...
//    @Disabled("구현 중")
    ...
    public void givenNothing_whenRequestArticlesView_thenReturnsArticlesView() throws Exception {
        ...
        mvc.perform(get("/articles"))
                ...
                .andExpect(content().contentTypeCompatibleWith(MediaType.TEXT_HTML)) // contentTypeCompaticleWith를 사용하여 UTF-8처럼 부가적으로 받는 것을 인정
